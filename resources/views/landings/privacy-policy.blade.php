...
@section('content')
    <div class="jumbotron" id="hero_image">
        <div class="container-fluid">
            <h1 class="text-white" style="font-size: 42px;">Privacy Policy</h1>
        </div>
    </div>
    <div class="container-fluid">
        <h1>Privacy Policy for Dinasti Garuda</h1>

        <p>At Dinasti Garuda, accessible from http://dinastigaruda.com/, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by Dinasti
            Garuda and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
            to the information that they shared and/or collect in Dinasti Garuda. This policy is not applicable to any
        ...
        <p>Dinasti Garuda follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Dinasti Garuda.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on Dinasti Garuda, which are sent directly to users'
        ...
        <p>Note that Dinasti Garuda has no access to or control over these cookies that are used by third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>

        <p>Dinasti Garuda's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>Dinasti Garuda does not knowingly collect any Personal Identifiable Information from children under the age of
