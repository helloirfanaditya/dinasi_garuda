...
@section('content')
    <div class="jumbotron" id="hero_image">
        <div class="container-fluid">
            <h1 class="text-white" style="font-size: 42px;">Term and Conditions</h1>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <p>Welcome to <b>Dinasti Garuda</b> !</p>
        <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
            <b>http://dinastigaruda.com/</b> (together or individually “Service”) operated by <b>Dinasti Garuda</b>.
        </p>
        ...
        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us
            know by emailing at <b>support@dinastigaruda.com</b> so we can try to find a solution. These Terms apply to all
        ...
        <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other
            ...
            following the unsubscribe link or by emailing at support@dinastigaruda.com.</p>
        ...
        <p>4. <b>Content</b></p>
        <p>Content found on or through this Service are the property of Dinasti Garuda or used with permission. You may not
        ...
        <p>Service and its original content (excluding Content provided by users), features and functionality are and will
            remain the exclusive property of Dinasti Garuda and its licensors. Service is protected by copyright, trademark,
            and other laws of and foreign countries. Our trademarks may not be used in connection with any product or
            service without the prior written consent of Dinasti Garuda.</p>
        ...
        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been
            ...
            support@dinastigaruda.com, with the subject line: “Copyright Infringement” and include in your claim a detailed
        ...
        <p>You can contact our Copyright Agent via email at support@dinastigaruda.com.</p>
        <p>12. <b>Error Reporting and Feedback</b></p>
        <p>You may provide us either directly at support@dinastigaruda.com or via third party sites and tools with
            ...
            create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>
        <p>13. <b>Links To Other Web Sites</b></p>
        <p>Our Service may contain links to third party web sites or services that are not owned or controlled by Dinasti
            Garuda.</p>
        <p>Dinasti Garuda has no control over, and assumes no responsibility for the content, privacy policies, or practices
        ...
        <p>These Terms shall be governed and construed in accordance with the laws of Indonesia, which governing law applies
        ...
        <p>We reserve the right to withdraw or amend our Service, and any service or material we provide via Service, in our
            sole discretion without notice. We will not be liable if for any reason all or any part of Service is
        ...
        <p>Please send your feedback, comments, requests for technical support by email: <b>support@dinastigaruda.com</b>.
        </p>
        <p style="margin-top: 5em; font-size: 0.7em;">These <a href="https://policymaker.io/terms-and-conditions/">Terms of
                Service</a> were created for <b>http://dinastigaruda.com/</b> by <a
                href="https://policymaker.io">PolicyMaker.io</a> on 2022-03-15.</p>
