@extends('admin.layouts.app',['title' => 'Create new Collection'])
@section('content')
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Create new Collection</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Create new Collection</h4>
                        </div>
                    </div>
                    <div class="col-12">
