@extends('admin.layouts.app',['title' => 'Edit News '.$news->title])
@section('content')
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Edit News {{ $news->title }}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Edit News {{ $news->title }}</h4>
                        </div>
                    </div>
                    <div class="col-12">
